...
string cfgName("disc_simple1.cfg");
...
double alpha[2] = {60, 320};	// start configuration
double beta[2] = {400, 160};	// goal configuration
...
// Qt/OpenGL Variables ===========================================
//
    static ControlWindow* controlWin; //this used to be static, John removed for debugging
...
int main(int argc, char* argv[])
{
    ...
    // include /disc
    int indexOfDesiredDir = workingDir.rfind("/disc-qt/");
